...
export const GOLDEN_CASES: GoldenCase[] = [
  ...
  },
  {
    ...
    spec: {
      ...
      nodes: [
        ...
        curlyArrow({ id: "a1", from: { x: 72, y: 100 }, to: { x: 188, y: 100 }, color: "#2563eb" }),
        curlyArrow({ id: "a2", from: { x: 232, y: 100 }, to: { x: 345, y: 100 }, color: "#dc2626", curvature: -45 }),
      ],
    },
    frames: [0],
  },
  ...
  },
  {
    ...
    spec: {
      ...
      seed: 1,
      background: "#ffffff",
      nodes: [rayDiagram({ id: "rd", x: 20, y: 16, width: 440, height: 250, focalLength: 78, object: { distance: 165, height: 66 } })],
    },
    frames: [0],
  },
  {
